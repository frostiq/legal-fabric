...
import { toggleForm, createAgreement, getAccounts, approveAgreement } from '../../redux/app/app.actions';
...
class Oracles extends Component {
  render() {
    const {showForm, toggleForm, account, contracts, oracles, approveAgreement} = this.props;
...
export default connect(
  ...
  { toggleForm, createAgreement, getAccounts, approveAgreement },
)(Oracles);